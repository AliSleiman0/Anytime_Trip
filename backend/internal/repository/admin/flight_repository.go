...
// UpdateProfitPercent updates the profit percent for a flight provider
func (r *FlightRepository) UpdateProfitPercent(ctx context.Context, id string, profitPercent float64) error {
	update := bson.M{
		"$set": bson.M{
