...
// UpdateRefundRequested updates the refund requested status for a flight booking
func (r *FlightBookingRepository) UpdateRefundRequested(ctx context.Context, id string, requested bool) error {
	update := bson.M{
		"$set": bson.M{
